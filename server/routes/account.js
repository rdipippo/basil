...
module.exports = function(app, db) {
	...
	app.post("/signup", function(req, res) {
		...
		req.check("name", req.t("NameCannotBeEmpty")).notEmpty();
		req.check("email", req.t("EmailCannotBeEmpty")).notEmpty();
		req.check("email", req.t("EmailIsNotValid")).isEmail();
		req.sanitize("email").normalizeEmail({ remove_dots: false });

		//req.check("username", req.t("UsernameCannotBeEmpty")).notEmpty();
		...
		if (!passwordless) {
			req.check("password", req.t("PasswordCannotBeEmpty")).notEmpty();
			req.check("password", req.t("PasswordTooShort")).len(6);
		}
	...
	app.post("/reset/:token", function(req, res, next) {
		req.check("password", req.t("PasswordTooShort")).len(6);
		req.check("confirm", req.t("PasswordNotMatched")).equals(req.body.password);
